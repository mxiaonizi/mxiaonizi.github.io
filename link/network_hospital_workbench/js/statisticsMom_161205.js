...
function setValue(DateCond,IsCityCond,AreaInfo,InstitutionCond,Illness,NHStatusList){
...
$("#analyInp").on("click",function(){//查看分析结果
	...
	if(dateTb.getTime() - dateTa.getTime() >2592000000){
...
//	药店状态
	...
	setValue(DateCond,IsCityCond,AreaInfo,InstitutionCond,Illness,instStatus);
	$("#form1").submit();
});
